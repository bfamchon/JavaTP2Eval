...
CREATE TABLE `hierarchie` (
  ...
  KEY `idFils` (`idFils`),
  CONSTRAINT `hierarchie_ibfk_1` FOREIGN KEY (`idPere`) REFERENCES `personne` (`id`),
  CONSTRAINT `hierarchie_ibfk_2` FOREIGN KEY (`idFils`) REFERENCES `personne` (`id`)
...
INSERT INTO `hierarchie` VALUES (0,1),(0,2),(2,3);
...
INSERT INTO `personne` VALUES (0,'AIRE','Axel','0304050607','Lent'),(1,'FICHIER','Sam','0000000000','Nul'),(2,'GOLAY','Jerry','0123456789','Ludique'),(3,' KOLLYCK','Al','012','Distrait');
...
-- Dump completed on 2016-11-24 19:17:29
